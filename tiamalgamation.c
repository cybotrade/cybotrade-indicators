...
struct ti_indicator_info ti_indicators[] = {
    ...
    {"andean_osc",
     ...
     3,
     {"open", "close"},
     {"period[50]", "signal_length[9]"},
     {"?bull_data", "?bear_data", "ao_data"},
     0,
     0,
     0},
    {"ao",
    ...
    {"bbands",
     ...
     {"real"},
     {"period[20]", "stddev[2]"},
     {"bbands_lower(ohlcv)", "bbands_middle(ohlcv)", "bbands_upper(ohlcv)"},
     0,
     0,
     0},
    {"boom_pro",
     ...
     2,
     {"close"},
     {"lp_period_one[6]", "k1_quotient[0]", "trig_no[2]", "lp_period_two[27]",
      "k22_eot[0.3]"},
     {"trigger(ohlc)", "q4(ohlc)"},
     0,
     0,
     0},
    {"bop",
    ...
    {"braid_filter",
     ...
     3,
     {"open", "high", "low", "close"},
     {"ma01_length[3]", "ma02_length[7]", "ma03_length[14]",
      "pips_min_sep_percent[40]"},
     {"?dif", "?atr_filter", "bar_color"},
     0,
     0,
     0},
    {"cci",
    ...
    {"half_trend",
     ...
     2,
     {"high", "low", "close"},
     {"amplitude[2]", "channel_deviation[2]", "atr_length[100]"},
     {"?ht(ohlc)", "bar_color"},
     0,
     0,
     0},
    {"heatmap_vol",
     ...
     1,
     {"volume"},
     {"length[610]", "std_length[610]", "threshold_extra_high[4]",
      "threshold_high[2.5]", "threshold_medium[1]", "threshold_normal[-0.5]"},
     {"heatmap_level"},
     0,
     0,
     0},
    ...
    {"macd_fastline_divergence",
     "MACD Fastline Divergence",
     ti_macd_fastline_divergence_start,
     ti_macd_fastline_divergence,
     0,
     TI_TYPE_OVERLAY,
     3,
     3,
    ...
    {"macd_hist_divergence",
     "MACD Hist Divergence",
     ti_macd_hist_divergence_start,
     ti_macd_hist_divergence,
     0,
     TI_TYPE_OVERLAY,
     3,
     3,
    ...
    {"mobo_band",
     ...
     1,
     {"high", "low"},
     {"dpo_length[13]", "mobo_length[10]", "num_dev_down[-0.8]",
      "num_dev_up[0.8]"},
     {"buy_sell_signal"},
     0,
     0,
    ...
    {"psar",
     ...
     1,
     {"high", "low", "close"},
     {"accel_start[0.02]", "accel_step[0.02]", "accel_max[0.2]"},
     {"psar(ohlc)"},
     0,
     0,
     0},
    {"qqe_mod",
     ...
     2,
     {"close"},
     {"rsi_length_one[6]", "rsi_smoothing_one[5]", "qqe_factor_one[3]",
      "threshold_one[3]", "rsi_length_two[6]", "rsi_smoothing_two[5]",
      "qqe_factor_two[1.61]", "threshold_two[3]", "bollinger_length[50]",
      "qqe_multiplier[0.35]"},
     {"bar_color_one", "bar_color_two"},
     0,
     0,
     0},
    {"roc",
    ...
    {"rsi_divergence",
     ...
     2,
     {"high", "low", "close"},
     {"left_bar[6]", "right_bar[2]", "rsi_length[14]"},
     {"bull", "bear"},
     0,
     0,
     0},
    ...
    {"rvi_divergence",
     ...
     2,
     {"high", "low", "close"},
     {"left_bar[6]", "right_bar[2]", "std_length[12]", "ema_length[14]"},
     {"bull", "bear"},
     0,
     0,
     0},
    ...
    {"ssl",
     ...
     6,
     {"high", "low", "close"},
     {"ma_length[60]", "ssl3_length[15]"},
     {"?bbmc(ohlc)", "bar_color", "?up_erk(ohlc)", "?low_erk(ohlc)",
    ...
    {"stc",
     ...
     2,
     {"close"},
     {"length[12]", "fast_length[26]", "slow_length[50]", "aaa[0.5]"},
     {"?stc", "bar_color"},
     0,
     0,
     0},
    ...
    {"stoch",
     ...
     2,
     {"high", "low", "close"},
     {"k_period[14]", "k_slowing_period[1]", "d_period[3]"},
     {"stoch_k", "stoch_d"},
     0,
     0,
     0},
    {"stoch_divergence",
     ...
     2,
     {"high", "low", "close"},
     {"left_bar[6]", "right_bar[2]", "stk_length[14]", "smooth_length[3]",
      "sma_length[3]"},
     {"bull", "bear"},
     0,
     0,
    ...
    {"stoch_rsi",
     ...
     2,
     {"close"},
     {"smoothk[3]", "smoothd[3]", "rsi_period[14]", "stoch_period[14]"},
     {"stoch_k", "stoch_d"},
     0,
     0,
     0},
    ...
    {"sup_and_res",
     ...
     16,
     {"close"},
     {"left_bar[200]", "right_bar_one[20]", "right_bar_two[5]",
      "hma_length[9]"},
     {"buy_one", "buy_two", "buy_three", "buy_four", "buy_five", "buy_six",
      "buy_seven", "buy_eight", "sell_one", "sell_two", "sell_three",
      "sell_four", "sell_five", "sell_six", "sell_seven", "sell_eight"},
     0,
     0,
     0},
    {"supertrend",
     ...
     {"high", "low", "close"},
     {"period[34]", "factor[3]"},
     {"?supertrend(ohlc)", "?direction", "bar_color", "buy_sell_signal"},
     0,
     0,
     0},
    {"tan",
    ...
    {"volatility_oscillator",
     "Volatility Oscillator",
     ti_volatility_oscillator_start,
     ti_volatility_oscillator,
     0,
     TI_TYPE_OVERLAY,
     2,
     1,
     ...
     {"open", "close"},
     {"length[100]"},
     {"spike_line", "upper_line", "lower_line"},
     0,
     0,
     0},
    {"vosc",
    ...
    {"vu_man_chu_swing",
     ...
     2,
     {"close"},
     {"swing_period[20]", "swing_multiplier[3.5]"},
     {"buy_sell_signal_long", "buy_sell_signal_short"},
     0,
     0,
     0},
    {"vwma",
    ...
    {"waddah",
     ...
     4,
     {"close"},
     {"fast_length[20]", "slow_length[40]", "signal_length[9]", "bb_length[20]",
      "multiplier[2]", "sensitivity[150]"},
     {"?t", "e", "trend_up", "trend_down"},
     0,
     0,
     0},
    {"wavetrend",
     ...
     2,
     {"high", "low", "close"},
     {"period_one[9]", "period_two[12]"},
     {"wavetrend_one", "wavetrend_two"},
     0,
     0,
     0},
    {"wcprice",
...
int ti_stream_get_progress(ti_stream *stream) { return stream->progress; }
void ti_stream_free(ti_stream *stream) {
